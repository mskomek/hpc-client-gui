...
If the project is useful in your research or HPC workflow and you would like to
support its continued development, voluntary sponsorships and donations are
appreciated.

Support can help with ongoing development, testing, documentation, release
maintenance, compatibility work, and future improvements.

## GitHub Sponsors

You can support HPC Client GUI through GitHub Sponsors with either a monthly or
one-time contribution:

[**Sponsor HPC Client GUI on GitHub**](https://github.com/sponsors/mskomek)

Available sponsorship options include monthly and one-time contributions.

## Bitcoin (BTC)

Bitcoin is also available as an alternative donation method.
