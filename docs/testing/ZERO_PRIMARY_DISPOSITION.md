...
Current report SHA: 13f1f9a8bd3a093c76e5034ef56e3140fd50d878
Current collected nodes: 2652
...
The complete machine-readable fields (owner packet, rewrite/deletion policy, comparison requirement, and final status) are in audit/test-taxonomy/zero-primary-disposition.json. The original seven-failure inventory and incomplete-full-suite caveat remain in the frozen baseline archive. Packet M remains in progress because a truthful concurrency rewrite exposed a separate jobs-output overlap defect; that defect is not one of these zero-primary exceptions.
