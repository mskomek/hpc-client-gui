...
|---|---|---|---|---|
| GUI-WORKSPACE-001 | COVERED | main_window.py | wx_shell.py | test_wx_shell.py; test_wx_layout_resize.py |
| GUI-VISUAL-001 | PARTIAL | audit/gui-screenshots/qt | audit/gui-screenshots/wx | test_wx_layout_resize.py |
...
| GUI-TERM-001 | COVERED | terminal_widget.py | wx_terminal.py | test_wx_terminal.py; test_wx_embedded_terminal.py |
...
| GUI-XFER-001 | COVERED | transfer_dialog.py | wx_transfer_workspace.py | test_wx_files_sync_compare.py; test_transfer_concurrency.py |
| GUI-XFER-002 | COVERED | ftp_widget.py | wx_transfer_workspace.py | test_wx_files_sync_compare.py; test_local_transfer_gate.py |
| GUI-JOBS-001 | COVERED | jobs_widget.py | wx_jobs.py | test_wx_jobs.py |
| GUI-JOBS-002 | COVERED | jobs_outputs_widget.py | wx_jobs.py | test_wx_jobs_files_outputs.py; test_jobs_outputs_scroll.py; test_wx_jobs.py; test_wx_jobs_behavior.py |
...
| GUI-EDIT-001 | COVERED | editor_widget.py | wx_editor.py | test_wx_editor_tabs.py; test_wx_editor.py |
| GUI-EDIT-002 | COVERED | main_window.py | wx_shell.py; wx_editor_windows.py; wx_editor_view.py | test_wx_editor_tabs.py; test_wx_editor.py; test_wx_editor_window_parity.py; test_wx_remote_editor_flow.py; test_wx_term002.py |
| GUI-PLUGIN-001 | COVERED | plugin_manager_dialog.py | wx_plugins.py | test_wx_plugins.py |
| GUI-PLUGIN-002 | COVERED | ansys_lint_results_dialog.py | wx_ansys_view.py; wx_ansys.py | test_wx_ansys_view.py; test_wx_ansys.py |
