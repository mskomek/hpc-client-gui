...
class EditorFlowTests(unittest.TestCase):
    ...
    def test_save_shell_emits_run_request_after_write(self):
        ...
        path = "/arf/scratch/user/run.sh"
        self.w.path_in.setText(path)
        self.w.text.setPlainText("echo ok")

        self.w.save_path(run_in_terminal=True)

        self.assertEqual(self.files.data[path], "echo ok")
    ...
    def test_save_action_visibility_follows_script_type(self):
        ...
        self.assertTrue(self.w.btn_save_run.isVisible())
    ...
    def test_document_tabs_are_closable(self):
        ...
        self.w.document_tabs.tabCloseRequested.emit(1)
