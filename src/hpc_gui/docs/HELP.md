...
> **Unofficial client-side GUI** to simplify **SSH / Slurm / X11 workflows** on the **HPC system** or any similar **Slurm-based HPC**.
>
> This software is **not an official HPC tool**.
...
- Please report bugs with:
  - steps to reproduce
  - relevant excerpt from `~/.HPC_slurm_gui/app.log`
---
