...
> Bu uygulama **Slurm tabanlı HPC sistemlerinde** SSH + Slurm + (gerekirse) X11 iş akışını kolaylaştıran **resmî olmayan** bir istemci arayüzüdür.
...
- Sorun yaşarsan log dosyasına bak: `~/.HPC_slurm_gui/app.log`
