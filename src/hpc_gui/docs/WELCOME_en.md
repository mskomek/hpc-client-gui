...
> This application is an **unofficial, client-side GUI** that simplifies **SSH + Slurm + (when needed) X11** workflows across **Slurm-based HPC systems**.
...
- If something goes wrong, check the log file: `~/.HPC_slurm_gui/app.log`
