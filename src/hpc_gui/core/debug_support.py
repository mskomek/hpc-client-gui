...
def log_startup_snapshot() -> None:
    ...
    log = get_logger("hpc_gui.startup")
    try:
    ...
    try:
        from hpc_gui.services.putty_manager import plink_path
    ...
    try:
        from hpc_gui.services.xserver_manager import vcxsrv_executable_path
...
def log_exception_with_id(area: str, exc: BaseException, *, logger_name: str = "hpc_gui") -> ErrorId:
