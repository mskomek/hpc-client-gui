...
FEATURE_EVIDENCE = {
    ...
    "GUI-SHELL-003": Evidence("PARTIAL", "main_window.py", "wx_lifecycle.py", "test_wx_lifecycle.py"),
    ...
    "GUI-FILE-002": Evidence("PARTIAL", "main_window.py", "wx_editor.py", "test_local_edit_flow.py"),
    ...
    "GUI-JOBS-002": Evidence("PARTIAL", "jobs_outputs_widget.py", "wx_jobs.py", "test_jobs_outputs_scroll.py"),
