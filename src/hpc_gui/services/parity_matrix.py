...
FEATURE_EVIDENCE = {
    ...
    "GUI-TERM-001": Evidence("PARTIAL", "terminal_widget.py", "wx_terminal.py; wx_terminal_webview.py", "test_wx_terminal.py; test_wx_embedded_terminal.py; test_wx_terminal_webview.py; test_wx_terminal_parity_evidence.py", "Wave 77: WebView/xterm.js chain proven for input, output, resize, find, paste, generation guard, header state, lifecycle. Alternate screen and packaged WebView2 remain BLOCKED."),
