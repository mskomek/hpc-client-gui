...
FEATURE_EVIDENCE = {
    ...
    "GUI-SHELL-003": Evidence("COVERED", "main_window.py", "wx_shell.py", "test_wx_shell.py"),
    ...
    "GUI-FILE-002": Evidence("COVERED", "main_window.py", "wx_editor.py; wx_local_files.py", "test_local_edit_flow.py; test_wx_local_files.py"),
    "GUI-FILE-003": Evidence("COVERED", "local_dir_panel.py", "wx_local_files.py", "test_wx_local_files.py"),
    ...
    "GUI-JOBS-002": Evidence("COVERED", "jobs_outputs_widget.py", "wx_jobs.py", "test_jobs_outputs_scroll.py; test_wx_jobs.py"),
