...
FEATURE_EVIDENCE = {
    ...
    "GUI-XFER-001": Evidence("PARTIAL", "transfer_dialog.py", "wx_transfer_workspace.py", "test_transfer_concurrency.py", "Wave 48: sync browsing and directory comparison controls exist but are disabled/unwired; real controller path missing."),
    "GUI-XFER-002": Evidence("PARTIAL", "ftp_widget.py", "wx_transfer_workspace.py", "test_local_transfer_gate.py", "Wave 48: compare directories not wired to visible result; FTP workspace embedded but sync/compare missing."),
    "GUI-JOBS-001": Evidence("COVERED", "jobs_widget.py", "wx_jobs.py", "test_wx_jobs.py"),
    "GUI-JOBS-002": Evidence("PARTIAL", "jobs_outputs_widget.py", "wx_jobs.py", "test_jobs_outputs_scroll.py; test_wx_jobs.py; test_wx_jobs_behavior.py", "Wave 50: Details proven; Files/Outputs sub-tabs still placeholder TextCtrls without real datasource or live-tail."),
    ...
    "GUI-EDIT-001": Evidence("PARTIAL", "editor_widget.py", "wx_editor.py", "test_wx_editor.py", "Wave 51: single-document proven; dynamic multi-doc Notebook, dirty markers and duplicate suppression not yet embedded."),
    "GUI-EDIT-002": Evidence("PARTIAL", "main_window.py", "wx_shell.py; wx_editor_windows.py; wx_editor_view.py", "test_wx_editor.py; test_wx_editor_window_parity.py; test_wx_editor_cross_view_actions.py; test_wx_remote_editor_flow.py; test_wx_term002.py", "Wave 51: save/submit/run proven; multi-doc tab lifecycle still missing."),
